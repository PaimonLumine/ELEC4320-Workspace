...
namespace eval ::optrace {
  variable script "D:/OneDrive - HKUST Connect/HKUST/2023 Fall/ELEC4320/Workspace/FinalProject-1/FinalProject.runs/impl_1/TopModule.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir {D:/OneDrive - HKUST Connect/HKUST/2023 Fall/ELEC4320/Workspace/FinalProject-1/FinalProject.cache/wt} [current_project]
  set_property parent.project_path {D:/OneDrive - HKUST Connect/HKUST/2023 Fall/ELEC4320/Workspace/FinalProject-1/FinalProject.xpr} [current_project]
  set_property ip_output_repo {{D:/OneDrive - HKUST Connect/HKUST/2023 Fall/ELEC4320/Workspace/FinalProject-1/FinalProject.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{D:/OneDrive - HKUST Connect/HKUST/2023 Fall/ELEC4320/Workspace/FinalProject-1/FinalProject.runs/synth_1/TopModule.dcp}}
OPTRACE "read constraints: implementation" START { }
  read_xdc {{D:/OneDrive - HKUST Connect/HKUST/2023 Fall/ELEC4320/Workspace/FinalProject-1/FinalProject.srcs/constrs_1/imports/Project/Basys-3-Master.xdc}}
...
OPTRACE "Write Bitstream: pre hook" START { }
  set src_rc [catch { 
    puts "source {D:/OneDrive - HKUST Connect/HKUST/2023 Fall/ELEC4320/Workspace/FinalProject-1/FinalProject.srcs/nolocation.tcl}"
    source {D:/OneDrive - HKUST Connect/HKUST/2023 Fall/ELEC4320/Workspace/FinalProject-1/FinalProject.srcs/nolocation.tcl}
  } _RESULT] 
  if {$src_rc} { 
    set tool_flow [get_property -quiet TOOL_FLOW [current_project -quiet]]
    if { $tool_flow eq {SDx} } { 
      send_gid_msg -id 2 -ssname VPL_TCL -severity ERROR $_RESULT
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script {D:/OneDrive - HKUST Connect/HKUST/2023 Fall/ELEC4320/Workspace/FinalProject-1/FinalProject.srcs/nolocation.tcl} failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script {D:/OneDrive - HKUST Connect/HKUST/2023 Fall/ELEC4320/Workspace/FinalProject-1/FinalProject.srcs/nolocation.tcl} failed"
    }
    return -code error
  }
